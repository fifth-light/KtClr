...
fun main(args: Array<String>) {
    require(args.size == 1) { "Usage: MainGenerator <output.il>" }
    File(args[0]).writeText(generateMain())
}
...
private fun generateMain(): String = StringWriter().use {
            ...
            method(
                ...
                insn(
                    ...
                    ref = MethodReference(
                        declaringType = TypeReference(
                            resolutionScope = ResolutionScope.Assembly("Forwarder"),
                            name = "MyHelper",
                        ),
                        name = "GetMessage",
                ...
                insn(
                    ...
                    ref = MethodReference(
                        declaringType = TypeReference(
                            resolutionScope = ResolutionScope.Assembly("Forwarder"),
                            names = listOf("MyHelper", "NestedHelper"),
                        ),
                        name = "GetMessage",
                        returnType = Type.String,
                    ),
